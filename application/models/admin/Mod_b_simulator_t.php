<?php
class mod_b_simulator_t extends CI_Model {
	...
	public function barrier_status_down($coin_symbol, $barrier_status, $c_price,$start_date) {
		$this->mongo_db->limit(1);
		$start_date = $this->mongo_db->converToMongodttime($start_date);
	...
	public function last_procedding_candle_status($coin,$start_date){
		...
		$this->mongo_db->order_by(array('timestampDate'=>-1));
		$start_date =$this->mongo_db->converToMongodttime($start_date);
		$this->mongo_db->where_lte(array('timestampDate'=>$start_date));
