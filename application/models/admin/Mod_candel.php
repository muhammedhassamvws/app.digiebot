...
class mod_candel extends CI_Model {
    ...
    public function get_candelstick_data_from_database($var, $global_symbol, $periods, $from_date_object, $to_date_object, $previous_date, $forward_date) {
        ...
        foreach ($responseArr as $val_arr) {
            ...
            $start_date = $val_arr['openTime_human_readible'];
            $buyer_percentile = $this->get_trade_percentile($global_symbol, "ask", $var, $start_date);
            $seller_percentile = $this->get_trade_percentile($global_symbol, "bid", $var, $start_date);

            if ($var == 10) {
                $up_status = $val_arr['bigSellerContract1'] + $val_arr['bigSellerContract2'] + $val_arr['bigSellerContract3'] + $val_arr['bigSellerContract4'] + $val_arr['bigSellerContract5'] + $val_arr['bigSellerContract10'];
                $avg_score = $val_arr['bigBuyerContract1'] + $val_arr['bigBuyerContract2'] + $val_arr['bigBuyerContract3'] + $val_arr['bigBuyerContract4'] + $val_arr['bigBuyerContract5'] + $val_arr['bigSellerContract10'];
            }

            if ($var == 5) {
                $up_status = $val_arr['bigSellerContract1'] + $val_arr['bigSellerContract2'] + $val_arr['bigSellerContract3'] + $val_arr['bigSellerContract4'] + $val_arr['bigSellerContract5'];
                $avg_score = $val_arr['bigBuyerContract1'] + $val_arr['bigBuyerContract2'] + $val_arr['bigBuyerContract3'] + $val_arr['bigBuyerContract4'] + $val_arr['bigBuyerContract5'];
            }

            if ($var == 4) {
                $up_status = $val_arr['bigSellerContract1'] + $val_arr['bigSellerContract2'] + $val_arr['bigSellerContract3'] + $val_arr['bigSellerContract4'];
                $avg_score = $val_arr['bigBuyerContract1'] + $val_arr['bigBuyerContract2'] + $val_arr['bigBuyerContract3'] + $val_arr['bigBuyerContract4'];

            }

            if ($var == 3) {
                $up_status = $val_arr['bigSellerContract1'] + $val_arr['bigSellerContract2'] + $val_arr['bigSellerContract3'];
                $avg_score = $val_arr['bigBuyerContract1'] + $val_arr['bigBuyerContract2'] + $val_arr['bigBuyerContract3'];
            }

            if ($var == 2) {
                $up_status = $val_arr['bigSellerContract1'] + $val_arr['bigSellerContract2'];
                $avg_score = $val_arr['bigBuyerContract1'] + $val_arr['bigBuyerContract2'];
            }
            if ($var == 1) {
                $up_status = $val_arr['bigSellerContract1'];
                $avg_score = $val_arr['bigBuyerContract1'];
            }
            ...
            $final_arr[] = array(
                ...
                'buy_percentile' => $buyer_percentile,
                'sell_percentile' => $seller_percentile,
                'up_status' => $up_status,
                'avg_score' => $avg_score,
    ...
    public function get_order_array($symbol, $admin_id, $global_mode, $start_date_for_time_zone_time, $end_date_for_time_zone_time) {
        ...
        $search_Array = array(
            ...
            'created_date' => array('$gte' => $start_date_for_time_zone_time, '$lte' => $end_date_for_time_zone_time),
    ...
    public function getSentimentReportHour($type, $source, $coin, $startDateSocail, $end, $formula, $time) {
        ...
        if ($time == '1d') {
            ...
            if ($source == 'twitter') {$Table = 'sentiments_tweet_new_5';}
    ...
    public function get_trade_percentile($symbol, $type, $var, $start_date) {
        $this->mongo_db->where(array('coin' => $symbol, "modified_date" => array('$lte' => $this->mongo_db->converToMongodttime($start_date))));
