<!-- <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-tour/0.8.1/css/bootstrap-tour.min.css">
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-tour/0.8.1/js/bootstrap-tour.min.js"></script> -->
...
.G_current_val {
    ...
    box-shadow: -7px -1px 12px 0 rgba(0, 0, 0, 0.1);
    margin-left: 75%;
    width: 70%;
    z-index: 3;
}
...
.verti_bar_prog.verti_bar_prog_2 {
...
.verti_bar_prog_bottom {
    /* background: #5CBC32; */
    bottom: 0;
    /* background-image: url(https://images.clipartlogo.com/files/istock/previews/8046/80461989-painted-green-gradient-watercolor-background-on-paper.jpg); */
    color: #fff;
    height: 30%;
    position: absolute;
    text-align: center;
...
.verti_bar_prog_top {
    /* background: #FFE033; */
    /* background: #f11919;
    background-image: url(https://img.freepik.com/free-vector/royal-watercolor-valentine-red-background_1340-4028.jpg?size=338&ext=jpg); */
    color: #fff;
    height: 70%;
    position: absolute;
    text-align: center;
...
.verti_bar_prog {
    ...
    position: relative;
    width: 100%;
    /* background: url(https://i.pinimg.com/originals/18/50/d9/1850d98a3b8e5cf81bb45739f20c0a01.jpg); */
    background: #45484d;
...
<div id="content" style="background:#232323; padding-bottom: 0px;">
...
<div class="innerAll" style="padding-bottom:0px; padding-top:0px;">
<div class="row">
<section class="tradding_chart_1_sec">
  <div class="tradding_chart_1_main" style="padding:0px 15px 135px">
      <div class="towinone" id="one" data-step="1" data-intro="This is the Market Chart!">
        <div class="coin_symbol col-md-12">
        <div class="col-md-9">
    ...
    <div class="col-md-3"><button class="btn btn-default" id="start_tour">Start Demo</button></div>
</div>
...
<div class="price_sec_candle_main">
  ...
  .bar_candle.bc_15{
   ...
   <div class="barcalnd" id="two" data-step="2" data-intro="This Indicates the Contracts Calculations (Trade History)">
...
<style>
  ...
  .col-c-b-forest .color-box-bd {
  background: #228B22;
  }
	.color-box-up-down h3 {
	background: #6ec30c none repeat scroll 0 0;
	float: left;
	padding: 5px;
	width: 100%;
	}
	.color-box-up-down h4 {
    background: #ef2617 none repeat scroll 0 0;
    float: left;
    font-size: 12px;
    padding: 5px;
    width: 100%;
...
<div class="main-colors-box" id="three" data-step="3" data-intro="This indicates the candle and Order Book Indicators!">
  <div class="col-color-box col-c-b-white">
    ...
    <div class="col-color-box col-c-b-mehroon" id="up_down_wall">
      <div class="color-box-hd">
          <h2>OBW</h2>
        </div>
        <div class="color-box-bd" id="">
    ...
    <div class="col-color-box">
      <div class="color-box-hd">
        ...
        <div class="bottom_prog_box" id="response_pressure" data-step="4" data-intro="Isn't That Amazing! These are also the indicator of whole market including order book and trade history">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Chart3 Group</h4>
      </div>
      <div class="modal-body">
        <p>In Chart 3 Group there is complete picture of Market Depth and Trade History at every grouped price, Grouped Price contains prices at the certain number forexample if you have price 0.00000200 it will contains the prices of 0.00000200 to 0.00000204 etc. If you have open Orders, either Buy or Sell, it will be shown on respective Price you can view and edit that orders, If you do Right Click on the price, it will allow you to add a new order</p>
      </div>
...
<script type="text/javascript">
  ...
  function autoload_trading_chart_data(){
      ...
      $.ajax({
        type:'POST',
        url:'<?php echo SURL ?>admin/chart_group_test/autoload_trading_chart_data',
        ...
        success:function(response){
         ...
         var last_candle_ask = split_response[9];
          ...
          var str = split_response[26]
           if (str == 'down') {
            $('#up_down_wall').removeClass("col-c-b-mehroon");
            $('#up_down_wall').addClass("col-c-b-forest");
            str = 'Support';

           }else if(str == 'up'){
            $('#up_down_wall').removeClass("col-c-b-forest");
            $('#up_down_wall').addClass("col-c-b-mehroon");
            str = 'Resistance';
           }
          ...
          var candle_m_n = split_response[28];
          var candle_m = JSON.parse(candle_m_n);

          var candle_h_n = split_response[29];
          var candle_h = JSON.parse(candle_h_n)

          if (candle_m.bids >= 93 ) {
            candle_m.ask_quantity = '';
          }
          if (candle_m.asks >= 93 ) {
            candle_m.bid_quantity = '';
          }

          if (candle_h.bids >= 93 ) {
            candle_h.ask_quantity = '';
          }
          if (candle_h.asks >= 93 ) {
            candle_h.bid_quantity = '';
          }
          /*===============================================*/
         ...
         /* if(isNaN(roll_bid))
          ...
          if (last_ask_width >= 93 ) {
              last_bid = '';
          }
          if (last_bid_width >= 93 ) {
              last_ask = '';
          }
          if (curr_ask_width >= 93 ) {
              curr_bid = '';
          }
          if (curr_bid_width >= 93 ) {
              curr_ask = '';
          }
          if (roll_ask_per >= 93 ) {
              roll_bid = '';
          ...
          $(".last_bid").attr("d_vbppercent",last_bid_width+'%')
          ...
          var bid_p = split_response[30]
          var ask_p = split_response[31]
          ...
          var candle_m_n2 = split_response[32];
          var candle_m2 = JSON.parse(candle_m_n2);

          var candle_h_n2 = split_response[33];
          var candle_h2 = JSON.parse(candle_h_n2)


          if (candle_m2.bids >= 93 ) {
            candle_m2.ask_quantity = '';
          }
          if (candle_m2.asks >= 93 ) {
            candle_m2.bid_quantity = '';
          }

          if (candle_h2.bids >= 93 ) {
            candle_h2.ask_quantity = '';
          }
          if (candle_h2.asks >= 93 ) {
            candle_h2.bid_quantity = '';
          }
          /*===============================================*/
          ...
          var roll_bid_per1 = split_response[34];
          var roll_ask_per1 = split_response[35];
          var roll_bid1 = split_response[36];
          var roll_ask1 = split_response[37];
...
/*	Sval = makSval
	...
	var OG_HTML = '<div class="G_graph_box '+GB_cls+'" style="top:'+setTop+'px; height:'+setHeight+'px; z-index:3;"><div class="TP_line TP_line_start"><div class="TP_line_text">TP Buyer Zoon 1</div></div><div class="TP_line TP_line_end"><div class="TP_line_text">TP Buyer Zoon 2</div></div></div>';
...
function SelectedOrderPrice(zin,order_id,val,type,Qty){
  ...
  /*var last_li = $('.price_s_r_ul').first().attr('d_price');*/
  //alert(vary_first_price)
  if (temp == '') { return false; }
	if(thisplength_S ==0){
      ...
      $(('.price_s_r_ul > li')).each(function(index){
          ...
          if (temp < pos && temp >= second_li && (pos < vary_first_price)) {
              closest = second_li;
          }
          BoSval = closest;
...
//       placement: "auto",
//       backdropPadding: 5,
//       content: "This is the market Chart Showing The Order book and trade history on every price.",
//     });

//     tour.addStep({
//       element: "#two",
//       placement: "Contract Indicators",
//       title: "Step 3",
//       backdrop:true,
//       backdropPadding: 5,
//       content: "These indicators shows the Last Demand Candle, and Contracts Indicators including Current Candle, 5 minute, 15 minutes, X Contracts, X million Contracts etc.",
//     });
...
//       backdrop:true,
//       backdropPadding: 5,
//       content: "These indicators give knowledge about The Big Buyers and Sellers and Big Wall, Depth Pressure etc.",
//     });

//     tour.addStep({
//       element: "#response_pressure",
//       title: "Score Indicators",
//       placement: "auto",
//       backdrop:true,
//       backdropPadding: 5,
//       content: "These indicators are about Pressure, Blackwall, Yellow wall, Seven level Pressure, Score etc.",
//     });
//     // Initialize the tour
//     tour.init();
