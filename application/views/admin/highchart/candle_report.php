      ...
      <div class="widget-header">
        <h2>Filters</h2>
          ...
          <?php 
			  ...
			  if($tabNo==1){ }else{?>
               <div class="form-group col-md-1 pull-right" style="background: #162450; color: white; border:hidden;"> 
               <a href="<?php echo SURL ?>admin/highchart/next-session/<?php echo $page_post_data['tab_no']; ?>" style="color:#FFF;" class="btn btn-block btn-sm"  target="_blank" >Session New Tab</a> 
               </div>
          <?php } ?>
        ...
        <div class="col-md-12 af-border">
          <form action="<?php echo SURL;?>admin/highchart/candle-report"  id="highchartform" enctype="multipart/form-data" method="post">
            <div class="form-group col-md-3"> Select the session
              <select class="form-control form_session appendSessionData" name="form_session" id="form_session" >
          ...
          <div class="form-group col-md-1 emptydiv">
          .&nbsp;&nbsp;
          <button type="submit" name="submit" id="submit" class="btn btn-success btn-block btn-sm select_session" >Submit</button></div>
          </form>
          ...
          <div class="form-group col-md-1  add_session af-mb-3"> .&nbsp; <a type="submit" class="btn btn-primary btn-block btn-sm savesession" > Save Session </a> <img class="loader_image_main abcdLoader" src="http://app.digiebot.com/assets/images/loader.gif" style="display:none; margin-top: 7px;"> </div>
          ...
          <div class="form-group col-md-1"  style="padding-top: 27px;">
            <div class="fncy_check_box">
          ...
          <?php //if($hide_chart!=1){ ?>
          <div class="form-group col-md-1"  style="padding-top: 15px;">
            
            <!--<a href="<?php echo SURL;?>admin/highchart/candle-report-csv" class="btn btn-warning"><i class="glyphicon glyphicon-print"></i>&nbsp;&nbsp;Make CSV Report </a>-->
            
            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal"><i class="glyphicon glyphicon-print"></i>&nbsp;&nbsp;CSV</button>
            
            <!-- Modal -->
            <form action="<?php echo SURL;?>admin/highchart/candle-report-csv" method="post" id="">
                ...
                <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <h4 class="modal-title">Make Csv Report</h4>
                    </div>
                    <div class="modal-body" style="    height: 280px;">
                        <div class="form-group col-md-12">
              <label class="control-label">Start Date</label>
              <input type='text' class="form-control datetime_picker" name="start_date_csv" placeholder="Search By Start Date" value="<?php echo $startDate;?>" />
            </div>
                        <div class="form-group col-md-12">
              <label class="control-label">End Date</label>
              <input type='text' class="form-control datetime_picker" name="end_date_csv" placeholder="Search By End Date" value="<?php
echo $endDate;
?>" />
            </div>
              ...
              <select class="form-control coin_csv" name="coin_csv" id="coin_csv">
                <?php
...
?>
              ...
              <select class="form-control time_csv" name="time_csv" id="time_csv">
...
?>> Hour</option>-->
             ...
             <button type="submit" class="btn btn-success" name="create_csv" id="create_csv"  /><i class="fa fa-download" aria-hidden="true"></i>&nbsp;Download CSV</button>
...
?> > IN 10 M</option>
            ...
            <div class="form-group col-md-1">
              <label class="control-label" for=""> T3LTC</label>
...
echo ($page_post_data['chart_height'] == '800') ? 'selected="selected"' : '';
?>> Normal</option>
                <option value="1000" <?php
echo ($page_post_data['chart_height'] == '1000') ? 'selected="selected"' : '';
?>> Large </option>
...
?>> -1000 </option>
            ...
            <div class="form-group col-md-1">
              ...
              <small>Height Ø C M V</small>
              <select class="form-control average_c_m_v" name="average_c_m_v" id="average_c_m_v">
               
                <option value="1" <?php
echo ($page_post_data['average_c_m_v'] == '1') ? 'selected="selected"' : '';
?>> Default</option>
               
                <option value="10" <?php
echo ($page_post_data['average_c_m_v'] == '10') ? 'selected="selected"' : '';
?>> 10</option>


                <option value="20" <?php
echo ($page_post_data['average_c_m_v'] == '20') ? 'selected="selected"' : '';
?>> 20</option>

 <option value="30" <?php
echo ($page_post_data['average_c_m_v'] == '30') ? 'selected="selected"' : '';
?>> 30</option>

 <option value="40" <?php
echo ($page_post_data['average_c_m_v'] == '40') ? 'selected="selected"' : '';
?>> 40</option>


 <option value="50" <?php
echo ($page_post_data['average_c_m_v'] == '50') ? 'selected="selected"' : '';
?>> 50</option>

<option value="60" <?php
echo ($page_post_data['average_c_m_v'] == '60') ? 'selected="selected"' : '';
?>> 60</option>

<option value="70" <?php
echo ($page_post_data['average_c_m_v'] == '70') ? 'selected="selected"' : '';
?>> 70</option>

<option value="80" <?php
echo ($page_post_data['average_c_m_v'] == '80') ? 'selected="selected"' : '';
?>> 80</option>
<option value="90" <?php
echo ($page_post_data['average_c_m_v'] == '90') ? 'selected="selected"' : '';
?>> 90</option>

                <option value="100" <?php
echo ($page_post_data['average_c_m_v'] == '100') ? 'selected="selected"' : '';
?>> 100</option>
                <option value="500" <?php
echo ($page_post_data['average_c_m_v'] == '500') ? 'selected="selected"' : '';
?>> 500 </option>
                <option value="1000" <?php
echo ($page_post_data['average_c_m_v'] == '1000') ? 'selected="selected"' : '';
?>> 1000 </option>
                <option value="10000" <?php
echo ($page_post_data['average_c_m_v'] == '10000') ? 'selected="selected"' : '';
?>> 10000 </option>
                <option value="100000" <?php
echo ($page_post_data['average_c_m_v'] == '100000') ? 'selected="selected"' : '';
?>> 100000 </option>
              </select>
            </div>
...
?>>
              ...
              <label class="fncy_check_label">T<sub>4</sub>COT B/S</label>
            </div>
            <div class="form-group col-md-1">
              <div class="fncy_check_box">
...
?>>
              ...
              <label class="fncy_check_label">T<sub>4</sub>COT Buyer</label>
            </div>
            <div class="form-group col-md-1">
              <div class="fncy_check_box">
...
?>>
              ...
              <label class="fncy_check_label">T<sub>4</sub>COT Seller</label>
            </div>
            <div class="form-group col-md-1">
              <div class="fncy_check_box">
...
?>>
              ...
              <label class="fncy_check_label">T<sub>3</sub>LTC</label>
            </div>
            <div class="form-group col-md-1">
              <div class="fncy_check_box">
...
?>>
              ...
              <label class="fncy_check_label">T<sub>3</sub>LTC TIME</label>
            </div>
            <div class="form-group col-md-1">
              <div class="fncy_check_box">
...
?>>
              ...
              <label class="fncy_check_label">Support Barrier</label>
            </div>
            <div class="form-group col-md-1">
              <div class="fncy_check_box">
...
?>>
              ...
              <label class="fncy_check_label">Resistance Barrier</label>
            </div>
            <div class="form-group col-md-1">
              <div class="fncy_check_box">
...
?>>
              ...
              <label class="fncy_check_label">Binance Buy</label>
            </div>
          </div>
          <div class="col-md-12 ">
...
?>>
              ...
              <label class="fncy_check_label"> Binance Sell</label>
            </div>
            <div class="form-group col-md-1">
              <div class="fncy_check_box">
...
?>>
              ...
              <label class="fncy_check_label">Digie Buy</label>
            </div>
            <div class="form-group col-md-1">
              <div class="fncy_check_box">
...
?>>
              ...
              <label class="fncy_check_label">Digie Sell</label>
            </div>
            <div class="form-group col-md-1">
              <div class="fncy_check_box">
...
?>>
              ...
              <label class="fncy_check_label"><small>Buyer/Seller 5 R</small></label>
            </div>
...
?>>
              ...
              <label class="fncy_check_label">Current Market</label>
            </div>
              ...
              <div class="form-group col-md-1">
              <div class="fncy_check_box">
                <input type="checkbox" value="check45" name="check45" id="check45" class="checkbox" <?php
echo (in_array("check45", $box_session_data)) ? 'checked="checked"' : '';
echo $checboxValue;
?>>
                <label><span></span></label>
              </div>
              <label class="fncy_check_label"> High C M V</label>
            </div>
            
               <div class="form-group col-md-1">
              <div class="fncy_check_box">
                <input type="checkbox" value="check46" name="check46" id="check46" class="checkbox" <?php
echo (in_array("check46", $box_session_data)) ? 'checked="checked"' : '';
echo $checboxValue;
?>>
                <label><span></span></label>
              </div>
              <label class="fncy_check_label"> Lowest C M V</label>
            </div>
            
                <div class="form-group col-md-1">
              <div class="fncy_check_box">
                <input type="checkbox" value="check49" name="check49" id="check49" class="checkbox" <?php
echo (in_array("check49", $box_session_data)) ? 'checked="checked"' : '';
echo $checboxValue;
?>>
                <label><span></span></label>
              </div>
              <label class="fncy_check_label"> C M V Ø </label>
            </div>
                
                <div class="form-group col-md-1">
              <div class="fncy_check_box">
                <input type="checkbox" value="check47" name="check47" id="check47" class="checkbox" <?php
echo (in_array("check47", $box_session_data)) ? 'checked="checked"' : '';
echo $checboxValue;
?>>
                <label><span></span></label>
              </div>
              <label class="fncy_check_label"> H C M V Ø </label>
            </div>
                <div class="form-group col-md-1">
              <div class="fncy_check_box">
                <input type="checkbox" value="check48" name="check48" id="check48" class="checkbox" <?php
echo (in_array("check48", $box_session_data)) ? 'checked="checked"' : '';
echo $checboxValue;
?>>
                <label><span></span></label>
              </div>
              <label class="fncy_check_label"> L C M V Ø </label>
            </div>
...
?>>
              ...
              <label class="fncy_check_label"> <small>R 5 Bid %</small></label>
            </div>
...
?>>
              ...
              <label class="fncy_check_label"> <small>R 5 Ask %</small></label>
            </div>
...
?>>
              ...
              <div class="form-group col-md-1">
              <div class="fncy_check_box">
                <input type="checkbox" value="check52" name="check52" id="check52" class="checkbox" <?php
echo (in_array("check52", $box_session_data)) ? 'checked="checked"' : '';
echo $checboxValue;
?>>
                <label><span></span></label>
              </div>
              <label class="fncy_check_label"> L Q Time %</label>
            </div>
...
?>>
              ...
              <label class="fncy_check_label"> V B Bid %</label>
            </div>
...
?>>
              ...
              <label class="fncy_check_label"> <small>Ask Binance %</small></label>
            </div>
            <div class="form-group col-md-1">
              <div class="fncy_check_box">
...
?>>
              ...
              <label class="fncy_check_label"><small>Bid Binance %</small></label>
            </div>
               ...
               <div class="form-group col-md-1">
              <div class="fncy_check_box">
                <input type="checkbox" value="check50" name="check50" id="check50" class="checkbox" <?php
echo (in_array("check50", $box_session_data)) ? 'checked="checked"' : '';
echo $checboxValue;
?>>
                <label><span></span></label>
              </div>
              <label class="fncy_check_label"> C M V Ø  </label>
                ...
                <div class="form-group col-md-1"> 
                     <a type="submit" class="btn btn-primary btn-block btn-sm " name="clear" id="clear"  href="<?php echo SURL ?>admin/highchart/candle-report/clear">clear</a> 
                </div>
...
?>'
		...
		<?php if (!empty(in_array("check45", $box_session_data))){?>
		 {
           ...
           name: 'Highest C M V',
           color: '#003d07',
           data: [<?php echo $highest_market_value; ?>]
        },
		<?php }?>
		
		
		<?php if (!empty(in_array("check46", $box_session_data))){?>
		 {
           ...
           name: 'Lowest C M V',
           color: '#aaefb2',
           data: [<?php echo $lowest_market_value; ?>]
        },
		<?php }?>
		
		
		<?php if (!empty(in_array("check49", $box_session_data))){?>
		 {
           ...
           name: ' C M V Ø ',
           color: '#00e600',
           data: [<?php echo $current_market_value_sample; ?>]
        },
		<?php }?>
		
		
		<?php if (!empty(in_array("check47", $box_session_data))){?>
		 {
		  ...
		  tooltip: {
           ...
           name: 'HIGH C M V Ø',
           color: '#003300',
           data: [<?php echo $highest_market_value_sample; ?>]
        },
		<?php }?>
		
	<?php if (!empty(in_array("check48", $box_session_data))){?>
		 {
           ...
           name: 'LOW C M V Ø',
           color: '#ccffcc',
           data: [<?php echo $lowest_market_value_sample; ?>]
        },
		<?php }?>
...
function load_hight_chart_container2(){
    ...
    legend: {
		...
		<?php }?>
		<?php if (!empty(in_array("check52", $box_session_data))){?>
		{
             name: 'Last Qty Time %',
             color: '#000099',
             negativeColor: '#FF9999',
		...
		<?php if (!empty(in_array("check50", $box_session_data))){?>
		{
             name: 'C M V Ø For % ',
             color: '#66cc00',
