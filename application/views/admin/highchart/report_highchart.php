<?php
$page_post_data = $this->session->userdata('report_page_post_data');
$box_session_data = $this->session->userdata('report_page_post_data');
...
?>
 <div class="alert alert-success alert-dismissable savesessionmessaage" style="display:none;">Successfully Save session of against the coin .</div>
    ...
    <div class="widget widget-inverse">
      <div class="widget-body padding-bottom-none">
        ...
        <form action="<?php
echo SURL;
?>admin/highchart/candle-report"  id="highchartform" enctype="multipart/form-data" method="post">
          <div class="col-md-12 ">
...
?>
            ...
            <div class="form-group col-md-2">
              ...
              <select class="form-control trigger" name="trigger" id="trigger">
                ...
                <option value="box_trigger_3"> Barrier Trigger 3</option>
                <option value="barrier_trigger_simulator"> Barrier Trigger simulator</option>
                <option value="barrier_percentile_trigger"> Barrier Percentile </option>
              </select>
            </div>
...
?>>
            ...
            <div class="form-group col-md-1">
              <a type="submit" class="btn btn-primary btn-block btn-sm " name="clear" id="clear"  href="<?php echo SURL ?>admin/highchart/report/clear">clear</a>
            </div>
             ...
             <?php  if($page_post_data!=''){ ?>
                 ...
                 <!--    <div class="form-group col-md-3 ">
                    ...
                    <div class="form-group col-md-1">
                    <a type="submit" class="btn btn-primary btn-block btn-sm savesession" > Save Session </a>
                    </div>-->
            <?php }?>
            
            <div class="form-group col-md-2 ">
                     
              <!--<select class="form-control " name="get_session" id="get_session" onchange="this.form.submit()">
              <?php foreach($get_sesion_data_arr as $rowA){ ?>
                
                <option value="<?php echo $rowA->_id ?>" > <?php echo $rowA->session_name ?></option>
              <?php }?>
              </select>-->
          ...
          <!--   <input type="submit" class="btn btn-block btn-sm " name="OpenSession" id="OpenSession"  value="OpenSession">-->
             
             <?php }else{?>
              <div class="form-group col-md-1 pull-right" style="background: #162450; color: white; border:hidden;">
              <a href="<?php echo SURL ?>admin/highchart/next-session/<?php echo $page_post_data['tab_no']; ?>" style="color:#FFF;" class="btn btn-block btn-sm"  target="_blank" >Open New Session </a>
...
<script type="text/javascript">
  ...
  $(document).on('click','.savesession',function(){
      ...
      $.ajax({
        'url': '<?php echo base_url(); ?>admin/highchart/report_save_session',
