                  ...
                  <div class="col-md-12">
                    <div class="form-group col-md-12">
                      ...
                      <select name="order_level" id="order_level" class="form-control" required="required">
                          ...
                          <option value="level_11" <?php if ($order_arr['order_level'] == 'level_11') {echo "selected";}?>>Rule 11</option>
                          <option value="level_12" <?php if ($order_arr['order_level'] == 'level_12') {echo "selected";}?>>Rule 12</option>
                          <option value="level_13" <?php if ($order_arr['order_level'] == 'level_13') {echo "selected";}?>>Rule 13</option>
                          <option value="level_14" <?php if ($order_arr['order_level'] == 'level_14') {echo "selected";}?>>Rule 14</option>
                          <option value="level_15" <?php if ($order_arr['order_level'] == 'level_15') {echo "selected";}?>>Rule 15</option>
                      </select>
                    </div>
                  </div>
                </div>
                 ...
                 <div class="row">
                  ...
                  <div class="row percentage_tip" style="display: none;">
                      <div class="checkbox-animated">
                          ...
                          <input type="number" id="lth_profit" name="lth_profit" step="0.1" min="0" max="100" class="form-control" value="<?php echo $order_arr['lth_profit']; ?>">
                      </div>
                  </div>
                      ...
                      <div class="form-group col-md-12">
                        <label class="control-label">Select Stop Loss</label>
                          ...
                          <?php if ($order_arr['trigger_type'] == 'barrier_percentile_trigger'){
                            ...
                            <option value="percentile_stop_loss" <?php if ($order_arr['stop_loss_rule'] == 'percentile_stop_loss') {echo "selected";}?> >percentile_stop_loss</option>
                            <?php
                          }else{
...
?>
                      ...
                      <div class="col-md-4 loss_decimal">
                        ...
                        <input type="number" id="loss_decimal" name="ldecimal" required="required" class="form-control" onchange="setTwoNumberDecimal22()" step="0.01" max="0.99" min="0.00" value="<?php echo $fraction1; ?>" />
...
?>                      <option value="1"<?php if ($intpart == 1) {echo "selected";}?>>1</option>
                      ...
                      <div class="form-group col-md-4 decimal" style="padding-left:35px;">
                        ...
                        <input type="number" id="decimal" name="decimal" required="required" class="form-control" onchange="setTwoNumberDecimal22()" step="0.01" max="0.99" min="0.00" value="<?php echo $fraction; ?>" />
