  ...
  <div class="innerAll spacing-x2">
    ...
    <div class="widget widget-inverse">
        <div class="widget-body bg-white">
          ...
          <form action="<?php echo SURL; ?>admin/candle_base/edit_candle_base" method="post">
            <div class="widget-body"> 
          <!-- Row -->
          <div class="row"> 
             <div class="col-md-12"> 
              <div class="form-group col-md-12">
                <input type="hidden" name="id" value="<?php echo $base_id ?>">
                <label class="control-label" for="old_password">Select Coin</label>
                <select class="form-control" name="coins" id="coin" >
                  <?php 
                  foreach ($coins as $coin) {
                    if ($coin['symbol'] == $base_arr[0]['coin']) {
                    ...
                    ?>
                    <option value="<?php echo $coin['symbol'] ?>" <?php echo $selected; ?>><?php echo $coin['symbol']; ?></option>
                  <?php }
                  ?>
                </select>
              </div>
            ...
            <div class="col-md-12"> 
              <div class="form-group col-md-12">
                ...
                <input class="form-control datetime_picker" value="<?php echo $base_arr[0]['start_date']; ?>" name="start_date" type="text" required="required" />
              </div>
            </div>
             ...
             <div class="col-md-12"> 
              <div class="form-group col-md-12">
                ...
                <input class="form-control datetime_picker" value="<?php echo $base_arr[0]['end_date']; ?>" id="new_pass" name="end_date" type="text" required="required" />
              </div>
            </div>
            <script type="text/javascript">
             ...
             <div class="col-md-12"> 
              <div class="form-group col-md-12">
                ...
                <input class="form-control" id="confirm" value="<?php echo $base_arr[0]['base_value']; ?>" name="base_candle" type="text" required="required" />
              </div>
            </div>
