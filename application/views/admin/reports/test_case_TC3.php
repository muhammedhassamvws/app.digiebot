...
<div id="content">
  <h1 class="content-heading bg-white border-bottom">Test Case(TC3 users)</h1>
...
<?php } ?>
<?php $filter_data = $this->session->userdata('filters_users_tc3');
...
<div class="widget widget-inverse">
      <div class="widget-body padding-bottom-none" style="background: #67d2d724 !important;">
          <form method="POST" action="<?php echo SURL; ?>admin/Reports/get_TC3_users" id="users_filter">
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-2 ax_35" style="margin-top: 27px;">
                <div class="Input_text_btn">
                  ...
                  <a href="<?php echo SURL; ?>admin/Reports/resetFilters_tc3"class="btn btn-danger button3">Reset</a>
                  </span>   
                </div>
            </div>
          </div>
  ...
  <div class="widget-head" style="background-color: white !important; margin-top:3px; margin-right: 15px; margin-bottom: 2px;">
    ...
    <div class="widget-body padding-bottom-none">
        ...
        <table class=" table table-bordered table-hover" id="datatable" width="100%"> 
          ...
          <tbody>
<?php
if (count($TC3_users) > 0) {
	for ($i = 0; $i < count($TC3_users); $i++) {
		?>
        <?php if($TC3_users[$i]['tokenStatus'] == 'blacklisted'){ 
         ...
         <tr class="gradeX" <?php echo $danger_class; ?> <?php echo $tooltip; ?> data-id="<?php echo $TC3_users[$i]['_id']; ?>">
              <td><?php echo $i + 1; ?></td>
              <td><?php echo $TC3_users[$i]['user_id']; ?></td>
              <td><?php echo $TC3_users[$i]['first_name']; ?></td>
              <td><?php echo $TC3_users[$i]['last_name']; ?></td>
              <td><?php echo $TC3_users[$i]['username']; ?></td>
              <td><?php echo $TC3_users[$i]['email_address']; ?></td>
              <td><?php echo $TC3_users[$i]['symbol']; ?></td>
              <td><?php echo $TC3_users[$i]['orders_count']; ?></td>
              <td><?php echo $TC3_users[$i]['exchange']; ?></td>
              <!-- <td><?php //echo //get_price_updated_at((string)$TC3_users[$i]['id']); ?></td> -->
              <td class="">
                <div class="three-dots"></div>
                <div class="btn-group btn-group-md ">
                  <?php $doc_id = $TC3_users[$i]['_id']; if($TC3_users[$i]['is_fixed'] != true){ ?> 
