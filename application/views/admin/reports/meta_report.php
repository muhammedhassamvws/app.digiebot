...
?>
               ...
               <div class="col-xs-12 col-sm-12 col-md-2" style="padding-bottom: 6px;">
                  <div class="Input_text_s">
                    <label>Black Wall: <br>
                       <small>
                        <label class="radio-inline"><input type="radio" value="g" name="optradio_blackwall">greater</label>
                        <label class="radio-inline"><input type="radio" value="l" name="optradio_blackwall">less</label>
                      </small>
                    </label>
               ...
               <div class="col-xs-12 col-sm-12 col-md-2" style="padding-bottom: 6px;">
                  <div class="Input_text_s">
                     <label>Yellow Wall:<br>  <small>
                        <label class="radio-inline"><input type="radio" value="g" name="optradio_yellow">greater</label>
                        <label class="radio-inline"><input type="radio" value="l" name="optradio_yellow">less</label>
                      </small></label>
               ...
               <div class="col-xs-12 col-sm-12 col-md-2" style="padding-bottom: 6px;">
                  <div class="Input_text_s">
                     <label>Big Buyers (%age):<br> <small>
                        <label class="radio-inline"><input type="radio" value="g" name="optradio_bigbuyers">greater</label>
                        <label class="radio-inline"><input type="radio" value="l" name="optradio_bigbuyers">less</label>
                      </small></label>
               ...
               <div class="col-xs-12 col-sm-12 col-md-2" style="padding-bottom: 6px;">
                  <div class="Input_text_s">
                     <label>Seven Level: <br> <small>
                        <label class="radio-inline"><input type="radio" value="g" name="optradio_sevenLevel">greater</label>
                        <label class="radio-inline"><input type="radio" value="l" name="optradio_sevenLevel">less</label>
                      </small></label>
               ...
               <div class="col-xs-12 col-sm-12 col-md-2" style="padding-bottom: 6px;">
                  <div class="Input_text_s">
                     <label>Resistance Barrier:<br> <small>
                        <label class="radio-inline"><input type="radio" value="g" name="optradio_resistance">greater</label>
                        <label class="radio-inline"><input type="radio" value="l" name="optradio_resistance">less</label>
                      </small></label>
               ...
               <div class="col-xs-12 col-sm-12 col-md-2" style="padding-bottom: 6px;">
                  <div class="Input_text_s">
                     <label>Support Barrier: <br> <small>
                        <label class="radio-inline"><input type="radio" value="g" name="optradio_support">greater</label>
                        <label class="radio-inline"><input type="radio" value="l" name="optradio_support">less</label>
                      </small></label>
               ...
               <div class="col-xs-12 col-sm-12 col-md-2" style="padding-bottom: 6px;">
                  <div class="Input_text_s">
                     <label>T1COT (B/S): <br> <small>
                        <label class="radio-inline"><input type="radio" value="g" name="optradio_t1COT">greater</label>
                        <label class="radio-inline"><input type="radio" value="l" name="optradio_t1COT">less</label>
                      </small></label>
               ...
               <div class="col-xs-12 col-sm-12 col-md-2" style="padding-bottom: 6px;">
                  <div class="Input_text_s">
                     <label>T4COT (B/S): <br> <small>
                        <label class="radio-inline"><input type="radio" value="g"  name="optradio_t4COT">greater</label>
                        <label class="radio-inline"><input type="radio"  value="l" name="optradio_t4COT">less</label>
                      </small></label>
               ...
               <div class="col-xs-12 col-sm-12 col-md-2" style="padding-bottom: 6px;">
                  <div class="Input_text_s">
                     <label>T1LTC (B/S): <br> <small>
                        <label class="radio-inline"><input type="radio" value="g" name="optradio_t1LTCV">greater</label>
                        <label class="radio-inline"><input type="radio" value="l" name="optradio_t1LTCV">less</label>
                      </small></label>
               ...
               <div class="col-xs-12 col-sm-12 col-md-2" style="padding-bottom: 6px;">
                  <div class="Input_text_s">
                     <label>T1LTC (Time):<br> <small>
                        <label class="radio-inline"><input type="radio" value="g" name="optradio_t1LTCT">greater</label>
                        <label class="radio-inline"><input type="radio" value="l" name="optradio_t1LTCT">less</label>
                      </small></label>
               ...
               <div class="col-xs-12 col-sm-12 col-md-2" style="padding-bottom: 6px;">
                  <div class="Input_text_s">
                     <label>T3LTC (Time):<br> <small>
                        <label class="radio-inline"><input type="radio" value="g" name="optradio_t3LTC">greater</label>
                        <label class="radio-inline"><input type="radio" value="l" name="optradio_t3LTC">less</label>
                      </small></label>
               ...
               <div class="col-xs-12 col-sm-12 col-md-2" style="padding-bottom: 6px;">
                  <div class="Input_text_s">
                     <label>Binance Sell: <br> <small>
                        <label class="radio-inline"><input type="radio" value="g"  name="optradio_bsell">greater</label>
                        <label class="radio-inline"><input type="radio"  value="l" name="optradio_bsell">less</label>
                      </small></label>
               ...
               <div class="col-xs-12 col-sm-12 col-md-2" style="padding-bottom: 6px;">
                  <div class="Input_text_s">
                     <label>Binance Buy:<br> <small>
                        <label class="radio-inline"><input type="radio" value="g"  name="optradio_bbuy">greater</label>
                        <label class="radio-inline"><input type="radio"  value="l" name="optradio_bbuy">less</label>
                      </small></label>
