...
?>
      ...
      <div class="widget widget-inverse">
         <div class="widget-body">
            <form method="POST" action="<?php echo SURL; ?>admin/reports/rule_trigger_value">
              <div class="row">
        ...
        if (!empty($value)) {
            ?>
                        <tr>
                          ...
                          <td><?=$value['trigger_type'];?></td>
                          <td><?=$value['test_exist'];?></td>
                          <td><?=$value['live_exist'];?></td>
                          <td><?=$value['buy_rule_number'];?></td>
                          <td><?=$value['test_example'];?></td>
                          <td><?=$value['live_example'];?></td>
                        </tr>
                      <?php
}
    }
