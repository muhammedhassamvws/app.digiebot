    ...
    ?>
            <table class="table">
              <tr class="coin_symbol">
                ...
                <?php $trigger_meta = $coin_array['coin_meta'];?>
                      <td><span style="font-weight: bolder;">Total Coin Counts:</span> <?=$trigger_meta['total']?></td>
           ...
           <!--  <div >
            ...
            <table class="table table-stripped">
              <tr class="theadd">
                <td><?php if ($filter_user_data['group_filter'] == 'rule_group') {?>Rule Number <?php } else {?> Trigger Name <?php }?></td>
                <td>Total Order</td>
                <td>Average Profit</td>
                <td>Avg 5h Max Profit</td>
                <td>Avg 5h Min Profit</td>
                <td>Avg High Max Profit</td>
                <td>Avg Low Min Profit</td>
                <td>Total Winning Trades</td>
                <td>Total Losing Trades</td>
                <td>Greater Then 1% Profit</td>
                <td>Greater Then 2% Profit</td>
                <td>Greater Then 2% Loss</td>
                <td>opportunities</td>
                <td>Avg Five Hour High Price</td>
                <td>Avg Five Hour Low Price</td>
                <td>Avg High Price</td>
                <td>Avg Low Price</td>
        ...
        if ($trigger_key != 'coin_meta') {
            ...
            ?>
              <tr>
                <td class="heading"><?php echo strtoupper(str_replace("_", " ", $trigger_key)); ?></td>
                <td><?=$trigger_value['trigger_count'];?></td>
                <?php
if ($trigger_value['avg_profit'] >= 0) {?>
            <td class="text-success"><?=$trigger_value['avg_profit'];?></td>
        <?php } else {?>
            <td class="text-danger"><?=$trigger_value['avg_profit'];?></td>
        <?php }
            ?>

            <?php
if ($trigger_value['max_profit_5h'] >= 0) {?>
            <td class="text-success"><?=$trigger_value['max_profit_5h'];?></td>
        <?php } else {?>
            <td class="text-danger"><?=$trigger_value['max_profit_5h'];?></td>
        <?php }
            ?>

            <?php
if ($trigger_value['min_profit_5h'] >= 0) {?>
            <td class="text-success"><?=$trigger_value['min_profit_5h'];?></td>
        <?php } else {?>
            <td class="text-danger"><?=$trigger_value['min_profit_5h'];?></td>
        <?php }
            ?>

            <?php
if ($trigger_value['max_profit_high'] >= 0) {?>
            <td class="text-success"><?=$trigger_value['max_profit_high'];?></td>
        <?php } else {?>
            <td class="text-danger"><?=$trigger_value['max_profit_high'];?></td>
        <?php }
            ?>

            <?php
if ($trigger_value['min_profit_low'] >= 0) {?>
            <td class="text-success"><?=$trigger_value['min_profit_low'];?></td>
        <?php } else {?>
            <td class="text-danger"><?=$trigger_value['min_profit_low'];?></td>
        <?php }
            ?>
                <td><?=$trigger_value['winning_trades'];?></td>
                <td><?=$trigger_value['losing_trades'];?></td>
                <td><?=$trigger_value['top_1_per'];?></td>
                <td><?=$trigger_value['top_2_per'];?></td>
                <td><?=$trigger_value['bottom_2_per'];?></td>
                <td><a href="javascript:void(0)" data-toggle="modal" data-target="#exampleModal_<?=$coin_key . $trigger_key?>"><?=$trigger_value['opp']['op'];?></a></td>
                <td><?=$trigger_value['high_five_average'];?></td>
                <td><?=$trigger_value['low_five_average'];?></td>
                <td><?=$trigger_value['max_high_average'];?></td>
                <td><?=$trigger_value['max_low_average'];?></td>
            ...
            <?php
foreach ($coin_array as $tkey => $tvalue) {
        ?>
                          <div class="modal fade sherzaman" id="exampleModal_<?=$coin_key . $tkey?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog" role="document" style="min-width: 75%;">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Oppurtunity Detail</h5>
        ...
        ?>
            ...
            ?>
                        ...
                        <div class="totalAvg"><strong>Total Average</strong>: <?php echo number_format(($total_avg / $total), 2); ?></div>
                      </div>
