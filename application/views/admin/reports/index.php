...
[type="checkbox"]:checked:focus + label:before,  [type="checkbox"]:not(:checked):focus + label:before,  [type="checkbox"]:checked:focus + label:before,  [type="checkbox"]:not(:checked):focus + label:before {
  ...
  <div class="container center_div">
    <div class="text-center" style="padding:50px 0">
      ...
      <div class="login-form-1">
        <form id="login-form" method="POST" action="<?php echo SURL; ?>admin/reports/get_report" class="text-left">
          <div class="login-form-main-message"></div>
          <div class="main-login-form">
            <div class="login-group">
              <div class="form-group">
                <label class="sr-only">Select Customer</label>
                <select name="admin_id" class="selectpicker form-control" data-live-search="true">
...
foreach ($customers as $key => $value) {
    ...
    ?>
                  <option value="<?php echo $value['_id'] ?>"><?php echo $value['first_name'] . ' ' . $value['last_name']; ?></option>
                  <?php }
...
?>
      ...
      <div class="logo">Trade History Report</div>
      <div class="login-form-1">
        <form id="login-form" method="POST" action="<?php echo SURL; ?>admin/reports/download_csv_trades" class="text-left">
          <div class="login-form-main-message"></div>
          <div class="main-login-form">
            <div class="login-group">
              <div class="form-group">
                <select class="selectpicker form-control" name="coin" data-live-search="true" >
              ...
              <div class="form-group">
                <label class="sr-only">Select Date Range</label>
                <input type="text" name="date" id="new_date_picker" placeholder="Select Date Range" class="form-control">
              </div>
            </div>
            <button type="submit" class="login-button"><i class="fa fa-chevron-right"></i></button>
          </div>
      ...
      <div class="logo">Price History Report</div>
      <div class="login-form-1">
        <form id="login-form" method="POST" action="<?php echo SURL; ?>admin/reports/download_csv_prices" class="text-left">
          <div class="login-form-main-message"></div>
          <div class="main-login-form">
            <div class="login-group">
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="sr-only">Select Date Range</label>
                <input type="text" name="date" id="new_date_picker3" placeholder="Select Date Range" class="form-control">
              </div>
            </div>
            <button type="submit" class="login-button"><i class="fa fa-chevron-right"></i></button>
          </div>
      ...
      <div class="logo">Order History Log</div>
      <div class="login-form-1">
        <form id="login-form" method="POST" action="<?php echo SURL; ?>admin/reports/order_history_log" class="text-left">
          <div class="login-form-main-message"></div>
          <div class="main-login-form">
            <div class="login-group">
              <div class="form-group">
                <select class="selectpicker form-control" name="order_id" data-live-search="true" >
                  <option value="">Select Order</option>
                  <?php foreach ($orders as $key => $value) {?>
                  <option value="<?php echo $value['_id']; ?>"><?php echo $value['symbol'] . ' ( ' . $value['quantity'] . ' ) '; ?></option>
                  <?php }?>
                </select>
              </div>
              <div class="form-group">
                <label class="sr-only">Select Date Range</label>
                <input type="text" name="date" id="new_date_picker2" placeholder="Select DateTime" class="form-control">
              </div>
            </div>
            <button type="submit" class="login-button"><i class="fa fa-chevron-right"></i></button>
          </div>
