...
<div id="content">
  <h1 class="content-heading bg-white border-bottom">Repeating Orders</h1>
  <div class="innerAll bg-white border-bottom">
  <ul class="menubar">
    <li class=""><a href="<?php echo SURL; ?>admin/trading_reports/chk_log_duplication/all_link_reports">Reports</a></li>
...
?>
      <?php $filter_user_data = $this->session->userdata('u_repeating_orders');?>
      <div class="widget widget-inverse">
         <div class="widget-body">
            <form method="POST" action="<?php echo SURL; ?>admin/trading_reports/chk_log_duplication/repeating_orders">
              <div class="row">
...
?>
               ...
               <div class="col-xs-12 col-sm-12 col-md-3" style="padding-bottom: 6px;">
                  <div class="Input_text_s">
                     ...
                     <input id="filter_by_start_date" name="filter_by_start_date" type="text" class="form-control datetime_picker filter_by_name_margin_bottom_sm" placeholder="Search By Date" value="<?=(!empty($filter_user_data['filter_by_start_date']) ? $filter_user_data['filter_by_start_date'] : "")?>" required>
               ...
               <div class="col-xs-12 col-sm-12 col-md-3" style="padding-bottom: 6px;">
                  <div class="Input_text_s">
                     ...
                     <input id="filter_by_end_date" name="filter_by_end_date" type="text" class="form-control datetime_picker filter_by_name_margin_bottom_sm" placeholder="Search By Date" value="<?=(!empty($filter_user_data['filter_by_end_date']) ? $filter_user_data['filter_by_end_date'] : "")?>" required>
                     <i class="glyphicon glyphicon-calendar"></i>
                  </div>
               </div>
                  ...
                  <div class="Input_text_s">
                     ...
                     <select id="filter_by_status" name="filter_by_status" type="text" class="form-control filter_by_name_margin_bottom_sm">
                       <option value="">Search By Status</option>
                        ...
                        <option value="LTH"<?php if ($filter_user_data['filter_by_status'] == 'LTH') {?> selected <?php }?>>LTH</option>
                     </select>
                  </div>
               </div>
               <div class="col-xs-12 col-sm-12 col-md-3" style="padding-bottom: 6px;">
               ...
               <?php if(!empty($filter_user_data['optradio'])){ ?>
                    <?php $created_date_is_checked = ($filter_user_data['optradio'] == 'created_date' ? 'checked' : ''); ?>
                    <?php $modified_date_is_checked = ($filter_user_data['optradio'] == 'modified_date' ? 'checked' : ''); ?>
               <?php }else{ ?>
                    <?php $created_date_is_checked = ''; ?>
                    <?php $modified_date_is_checked = ''; ?>
               <?php } ?>
               
               <?php if(!empty($filter_user_data['selector'])){ ?>
                    <?php $asc_is_checked = ($filter_user_data['selector'] == 'ASC' ? 'checked' : ''); ?>
                    <?php $desc_is_checked = ($filter_user_data['selector'] == 'DESC' ? 'checked' : ''); ?>
               <?php }else{ ?>
                    <?php $asc_is_checked = ''; ?>
                    <?php $desc_is_checked = ''; ?>
               <?php } ?>
               ...
               <div class="col-xs-12 col-sm-12 col-md-4" style="padding-bottom: 6px;">
                  <div class="Input_text_s">
                     ...
                     <div class="af-radio-group">
                        <input class="af-cust-radio" value="created_date" name="optradio" type="radio" id="option-one"<?=$created_date_is_checked;?>>
                        <label class="af-custom-radio-label" for="option-one">Created Date</label>

                        <input class="af-cust-radio" value="modified_date" name="optradio" type="radio" id="option-two" <?=$modified_date_is_checked;?>>
                        <label class="af-custom-radio-label" for="option-two">Modified Date</label>
                     </div>
                     <div class="af-radio-group af-form-group-created">
                        <input class="af-cust-radio" value="ASC" type="radio" id="option-one2" name="selector" <?=$asc_is_checked;?>>
                        <label class="af-custom-radio-label" for="option-one2">ASC</label>
                        
                        <input class="af-cust-radio" value="DESC" type="radio" id="option-two2" name="selector" <?=$desc_is_checked;?>>
               ...
               <div class="col-xs-12 col-sm-12 col-md-12" style="padding-bottom: 6px;">
                  <div class="Input_text_btn">
                     ...
                     <a href="<?php echo SURL; ?>admin/trading_reports/chk_log_duplication/repeating_orders/reset" class="btn btn-danger"><i class="fa fa-times-circle"></i>Reset</a>
...
<!-- // added by 19/8/19 -->
        ...
        <!-- // added by 29/10/19 -->
        <td><a data-toggle="tooltip" data-placement="top" title="<?=(!empty($value['created_date']) ? $value['created_date']->toDatetime()->format("d-M, Y H:i:s") : ""); ?>">
            <?=(!empty($value['created_date']) ? "" : "");
            echo "<span class='label label-success'>" . time_elapsed_string($value['created_date']->toDatetime()->format("Y-m-d H:i:s")) . "</span>"?>
            </a>
        </td>
      ...
      <?php }
        ...
        <!-- // Table END -->
        <?php (!empty($pagination) ? $pagination : ''); ?>
      </div>
    </div>
    <!-- // Widget END -->
  </div>
