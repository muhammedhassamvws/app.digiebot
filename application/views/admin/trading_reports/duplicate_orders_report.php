...
<div id="content">
  <h1 class="content-heading bg-white border-bottom">Order Duplication</h1>
...
?>
      <?php $filter_user_data = $this->session->userdata('u_duplicate_orders_report');?>
      <div class="widget widget-inverse">
         <div class="widget-body">
            <form method="POST" action="<?php echo SURL; ?>admin/trading_reports/chk_log_duplication/duplicate_orders_report">
              <div class="row">
...
?>
               ...
               <div class="col-xs-12 col-sm-12 col-md-12" style="padding-bottom: 6px;">
                  <div class="Input_text_btn">
                     ...
                     <a href="<?php echo SURL; ?>admin/trading_reports/chk_log_duplication/duplicate_orders_report/reset" class="btn btn-danger"><i class="fa fa-times-circle"></i>Reset</a>
