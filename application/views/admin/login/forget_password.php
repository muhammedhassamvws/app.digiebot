      ...
      <div class="row justify-content-center h-100">
            <div class="col-12 col-sm-12 col-lg-3 text-white">
              <div class="row align-items-end h-50">
                  <div class="col-12">
                      <h1 class="border border-light border-top-0 border-bottom-0 border-right-0 pl-3 mt-5 mb-0">Forget Password</h1>
                    </div>
                </div>
                <div class="row align-items-end h-50">
                    <div class="col-12">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input name="email" type="email" class="form-control border border-top-0 border-left-0 border-right-0 btn-outline-light mb-5 pl-0 pr-0">
                                            </div>
                                        </div>
