...
?>
        ...
        <form method="post" role="form" action="<?php echo SURL ?>admin/login/login_process">
  ...
  <a href="<?php echo SURL; ?>admin/login/forget_password"><small>Forget Password ? Dont Worry Click Here</small></a>
</div>
      </div>
    </div>
  </div>
