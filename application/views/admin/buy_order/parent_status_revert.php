                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="order_id" class="form-control" name="order_id" placeholder="Enter Parent Id" value="<?php echo $this->session->userdata('parent_id');?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="user_id" class="form-control" name="user_id" placeholder="Enter user Id" value="<?php echo $this->session->userdata('admin_id'); ?>">
                            </div>
                        </div>

                        <!-- <?php// $exch = $this->session->userdata('exchange');if($this->session->userdata('exchange')){?>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Select Exchange:</label>
                                <select class="form-control" name="exchange" , id="exchange">
                                    <?php// if ($exch == 'binance') : ?>
                                        <option value="<?php //echo $this->session->userdata('exchange'); ?>" checked><?php// echo $this->session->userdata('exchange'); ?></option>
                      ...
                      <?php // } else { ?> -->
                        ...
                        <div class="col-md-1">
                            <div class="form-actions form-group" style="margin-top:22px">
                                <button class="btn btn-success" id="get_parent" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Processing Order">Get Parent Order</button>
                            </div>
                        </div>
                    </div>
...
<script>
    $('body').on("click", "#get_parent", function(e) {
        ...
        $.ajax({
            url: surl + "/admin/buy_orders/get_parent_ajax",
            data: { orderid: order_id, userid: user_id, exchange: exchange },
            type: "POST",
