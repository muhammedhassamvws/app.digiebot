                    ...
                    <div class="col-md-12">
                      <div class="form-group col-md-8">
                        ...
                        <div class="form-group col-md-4 decimal" style="padding-left:35px; display:none;">
                          ...
                          <!-- <input type="number" id="decimal" name="decimal" required="required" class="form-control" onchange="setTwoNumberDecimal22()" step="0.25" max="0.75" min="0.00" value="0.00" />-->
                ...
                if ($special_role == 1) {
                  ...
                  <div class="row percentage_tip" style="display: none;">
                      <div class="checkbox-animated">
                          ...
                          <input type="number" id="lth_profit" name="lth_profit" step="0.25" min="0" max="100" class="form-control">
                      </div>
                  </div>
