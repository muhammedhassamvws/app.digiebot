                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="form-group col-md-12">
                        ...
                        <input type="text" name="quantity" value="<?=((!empty($order_arr['updated_quantity']) ? $order_arr['updated_quantity'] : $order_arr['quantity']));?>" required="required" class="form-control" <?php if ($buy_order_check == 'yes') {?> readonly <?php }?>>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row" id="trail_sell_data" style="display:none;">
                    ...
                    <div class="col-md-12">
                      <div class="form-group col-md-12">
                        ...
                        <input type="text" id="sell_trail_interval" name="trail_interval" required="required" class="form-control">
                      </div>
                    </div>
                    <div class="col-md-12">
                         <span class="btn-group btn-group-xs">
