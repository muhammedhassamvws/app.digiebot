...
<div id="content">
  ...
  <div class="bg-white innerAll border-bottom">
    <ul class="menubar">
        ...
        <li class="active"><a href="<?=SURL;?>admin/buy_orders/edit-buy-trigger-order/<?=$info['buy_parent_id'];?>" target="_blank">Edit Parent Order</a></li>
    </ul>
  </div>
...
if (count($coins_arr) > 0) {
    for ($i = 0; $i < count($coins_arr); $i++) {
        ...
        if ($order_arr['symbol'] == $coins_arr[$i]['symbol']) {
            ?>
			                           <option value="<?php echo $coins_arr[$i]['symbol']; ?>" selected><?php echo $coins_arr[$i]['symbol'];
            ?></option>
			<?php }
    }
}?>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group col-md-12">
                        ...
                        <input type="text" name="purchased_price" id="purchased_price" value="<?php echo num($order_arr['purchased_price']); ?>" required="required" class="form-control" readonly>
                      </div>
                    </div>
...
if ($order_arr['trigger_type'] == 'trigger_2') {
    $trigger_class = 'trigger_css';
    ?>
	<div class="col-md-6"> </div>
	<?php
}
?>
                <div class="<?php echo $trigger_class; ?>"><!--Start of trigger type -->
...
?>
                  ...
                  <div class="row">
                    <div class="col-md-12" id="sell_profit_percent_div" <?php echo $style1; ?>>
                      ...
                      ?>
                      <div class="form-group col-md-12">
                        <label class="control-label">LTH Profit (%)</label>
                        <input type="text" name="sell_profit_percent" id="sell_profit_percent" value="<?php echo $info['lth_profit']; ?>" required="required" required="required" class="form-control">
                        <input type="hidden" name="lth_status" value="<?php echo  $status;?>">
                        <input type="hidden" name="status" value="<?php $order_arr['status'];?>">

                        <input type="hidden" name="buy_order_id" value="<?php $info['_id'];?>">
                        ...
                        <input type="hidden" name="lth_status" value="<?php echo  $status;?>">
                        <input type="hidden" name="status" value="<?php echo  $order_arr['status'];?>">
                      </div>
                        <?php } ?>
...
?>
                  ...
                  <div class="row" id="trail_sell_data" style="display:none;">
                    ...
                    <div class="col-md-12">
                      <div class="form-group col-md-12">
                        ...
                        <input type="text" id="sell_trail_interval" name="trail_interval" value = "<?php echo $order_arr['trail_interval'] ?>" required="required" class="form-control">
                      </div>
                    </div>
                    <div class="col-md-12">
                         <span class="btn-group btn-group-xs">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-check">
<?php if ($order_arr['stop_loss'] == 'yes') {$selected22 = 'checked';}
?>
...
?></span>
                   ...
                   <li>
                    <span><b>Profit/Loss Information</b></span>
                    <span class="count"><?php
$purchased_price = (float) $order_arr['purchased_price'];
$sell_price = (float) $order_arr['market_value'];

$profit = $sell_price - $purchased_price;
...
?>
<span>
<?php if ($order_arr['status'] != 'new') {
    ?>
	<?php echo $word; ?>
	Percentage: <span style="color: <?php echo $color; ?>;"><?php echo number_format($profit_per, 2) . '%';
    ?>
<?php } else {
    echo "-";
}?>
...
<?php ?></span>
                  ...
                  <li>
                    <span><b>Purchased Price</b></span>
                    <span class="count"><?php echo num($order_arr['purchased_price']); ?></span>
                  </li>

                   <li>
                    <span><b>Trail Stop</b></span>
                    <span class="count">
											<?php
$loss_percentage = $order_arr['loss_percentage'];
if (!empty($loss_percentage)) {
    $stop_loss = (float) $purchased_price - (((float) $purchased_price * $loss_percentage) / 100);
    echo num($stop_loss) . "(" . $loss_percentage . " %)";
} else {
    $percentage = (($info['stop_loss'] - $purchased_price) / $info['stop_loss']) * 100;
    echo num($info['stop_loss']) . "(" . number_format($percentage, 2) . " %)";
}
...
?>
                  ...
                  <li>
                    <span><b>Sold Price</b></span>
                    <span class="count"><?php echo (($order_arr['status'] == 'new') ? "-" : num($info['target_sell'])); ?></span>
                  </li>
                  <?php

if ($this->session->userdata('special_role') == 1) {

    if (isset($info['market_heighest_value']) && $info['market_heighest_value'] != '') {

        $market_heighest_value = $info['market_heighest_value'];
        $purchased_price = (float) $order_arr['purchased_price'];
        $profit = $market_heighest_value - $purchased_price;

        $profit_margin = ($profit / $market_heighest_value) * 100;
        ...
        ?>
                      <li>
                        <span><b>Maximum Market</b>  Percentage:</span>
                            <span style="color: <?php echo $color; ?>;"><?php echo number_format($profit_per, 2) . '%';
        ?>
                            </span>
                            <span style="margin-left:10px"><b>Heighest Market Value: <?php echo num($market_heighest_value); ?></b></span>
                      </li>
    ...
    ?>
                     ...
                     <?php
if (isset($info['market_lowest_value']) && $info['market_lowest_value'] != '') {

        $market_lowest_value = $info['market_lowest_value'];
        $purchased_price = (float) $order_arr['purchased_price'];
        ...
        ?>
                      <li>
                        <span><b>Minimum Market</b>  Percentage:</span>
                            <span style="color: <?php echo $color; ?>;"><?php echo number_format($profit_per, 2) . '%';
        ?>
                            </span>
                            <span style="margin-left:10px"><b>Minimum Market Value: <?php echo num($market_lowest_value); ?></b></span>
                      </li>
    ...
    ?>
                      ...
                      <?php
if (isset($info['5_hour_max_market_price']) && $info['5_hour_max_market_price'] != '') {

        $five_hour_max_market_price = $info['5_hour_max_market_price'];
        $purchased_price = (float) $order_arr['purchased_price'];
        ...
        ?>
                            ...
                            <span style="margin-left:10px"><b>Heighest Market Value 5/H: <?php echo num($five_hour_max_market_price); ?></b></span>
                      </li>
    ...
    ?>
                    ...
                    <?php
if (isset($info['5_hour_min_market_price']) && $info['5_hour_min_market_price'] != '') {

        $market_lowest_value = $info['5_hour_min_market_price'];
        $purchased_price = (float) $order_arr['purchased_price'];
        $profit = $market_lowest_value - $purchased_price;
        ...
        ?>
                  <li>
                    <span><b>Minimum Market</b> 5/H Percentage:</span>
                        <span style="color: <?php echo $color; ?>;"><?php echo number_format($profit_per, 2) . '%';
        ?>
                        </span>
                        <span style="margin-left:10px"><b>Minimum Market Value: 5/H <?php echo num($market_lowest_value); ?></b></span>
                  </li>
...
?>
          ...
          <div class="col-md-6">
            <div class="widget widget-inverse" style="display: none;">
	            ...
	            <div class="widget">
	              <div class="widget widget-inverse widget-scroll">
	                        ...
	                        <div class="widget-body padding-none">
	                            <div id="response_market_trading" style="overflow-y: scroll; outline: none;" tabindex="5000">
...
<script type="text/javascript">
	$("#response_market_trading").scroll(function() {
        if($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight) {
               // alert("Listing Occured the Scroll");
        	}
    });
