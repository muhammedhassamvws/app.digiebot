...
.towinone .price_s_r_main {
    width: 50%;
}
.towinone .price_sec_center_main {
    width: 50%;
}
.G_current_val {
    top: 1250px;
      ...
      <div class="towinone">
            <div class="price_s_r_main" id="response_trading_data">
                <ul class="price_s_r_ul">
                   ...
                   <li class="price_s_r_li" d_price="<?php echo $market_value; ?>" index="1">
                        <div class="buyer_prog_main">
                        </div>
                        <div class="price_cent_main">
...
<script type="text/javascript">
  ...
  // zi++;
  // MakeOrangeGreen_box(zi,'0.0010892','0.0010881','buy');
 ...
 /* if(thisplength_S==0 ){
  ...
  if(thisplength_E == 0){
   // alert('value not in range');
	...
	// if(thisplength_S ==0){
	// 	if(Eval < vary_first_price && Eval > vary_last_price ){
	// 		Sval = vary_first_price;
	// 	}else{
	...
	// }
	// if(thisplength_E ==0){
	// 	if(Sval > vary_last_price && Sval < vary_first_price ){
	// 		Eval = vary_last_price; 
	// 	}else{
	...
	/*if(Sval > vary_first_price){
		Sval = vary_first_price;
	}
	if(Eval < vary_last_price){
		Eval = vary_last_price;
	}
	
	
	if(Sval < vary_last_price){
		Sval = vary_last_price;
	}
	if(Eval > vary_first_price){
		Eval = vary_last_price;
	}*/
	
	
	//alert(vary_first_price+'---'+vary_last_price);
