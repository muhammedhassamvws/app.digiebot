...
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/candel_stick/font-awesome.min.css">
<link href="<?php echo base_url(); ?>assets/candel_stick/bootstrap-datetimepicker.css" rel="stylesheet">
<script src="<?php echo base_url(); ?>assets/candel_stick/moment-with-locales.js"></script>
<script src="<?php echo base_url(); ?>assets/candel_stick/bootstrap-datetimepicker.js"></script>
                            ...
                            <div class="rfi_row">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 loadinput">
                                        ...
                                        <button type="button" class="btn btn-success btn-block btn-sm wait_search_candel_by_date" style="display: none;">
                        ...
                        <div class="col-xs-3">
                            <div class="rfi_row">
                                <div class="col-md-6 pull-left">
                                    ...
                                    <button href="#" class="btn btn-info btn-sm btn-block Backward">
                                ...
                                <div class="col-md-6 pull-righ">
                                    <label for="comment" class="col-md-1">&nbsp;</label>
                                    <button class="btn btn-info btn-sm btn-block Forward">
...
<script src="<?php echo ASSETS; ?>candel_graph/candel_graph_day.js"></script>
