  ...
  <div class="innerAll spacing-x2">
        ...
        <div class="widget widget-inverse widget-scroll">  
            ...
            <div class="box-generic">
                ...
                <div class="tabsbar">
                    <ul>
                        <li class="glyphicons eye_open active"><a href="#tab2-3" data-toggle="tab"><i></i> New <strong>(<span id="counter1"><?php echo count($new_arr); ?></span>)</strong></a></li>
                        <li class="glyphicons circle_ok"><a href="#tab3-3" data-toggle="tab"><i></i> Filled <strong>(<span id="counter2"><?php echo count($filled_arr); ?></span>)</strong></a></li>
                        <li class="glyphicons circle_remove tab-stacked"><a href="#tab4-3" data-toggle="tab"><i></i> <span>Canceled <strong>(<span id="counter3"><?php echo count($cancelled_arr); ?></span>)</strong></span></a></li>
                        <li class="glyphicons warning_sign tab-stacked"><a href="#tab5-3" data-toggle="tab"><i></i> <span>Error<strong>(<span id="counter4"><?php echo count($error_arr); ?></span>)</strong></span></a></li>
                        <li class="glyphicons show_big_thumbnails"><a href="#tab1-3" data-toggle="tab"><i></i> View all Sell Orders <strong>(<span id="counter5"><?php echo count($orders_arr); ?></span>)</strong></a></li>
...
<script type="text/javascript">
    ...
    function autoload_market_data(){
      ...
      $.ajax({
        type:'POST',
        url:'<?php echo SURL?>admin/dashboard/autoload_market_data2',
        data: "",
