...
<div id="content">
  <h1 class="content-heading bg-white border-bottom">Add Target Zone</h1>
  <div class="bg-white innerAll border-bottom">
	<ul class="menubar">
    	<li><a href="<?php echo SURL; ?>admin/dashboard/zone-listing">Target Zones Listing</a></li>
      <li class="active"><a href="#">Add Target Zone</a></li>
	</ul>
  </div>
  <div class="innerAll spacing-x2">
    ...
    <div class="widget widget-inverse"> 
        <div class="widget widget-inverse"> 
            <form class="form-horizontal margin-none" method="post" action="<?php echo SURL?>admin/dashboard/add-zone-process" novalidate="novalidate">
              ...
              <div class="row">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <select name="coin" class="form-control">
                      ...
                      <?php 
                       ...
                       ?> 
                      <option value="<?php echo $coins_arr[$i]['symbol'];?>"><?php echo $coins_arr[$i]['symbol'];?></option>
                      <?php }
                      } ?>
                    </select>
                  </div>
                ...
                <div class="col-md-6"> 
                  <div class="form-group col-md-12">
                    ...
                    <input type="text" name="start_value" required="required" class="form-control">
                  </div>
                </div> 
                <div class="col-md-6"> 
                  <div class="form-group col-md-12">
                    <label class="control-label">Enter End value</label>
                    <input type="text" name="end_value" required="required" class="form-control">
                  </div>
                </div> 
                <div class="col-md-6"> 
                  <div class="form-group col-md-12">
                   ...
                   <!--  <input type="text" name="start_date" required="required" class="form-control"> -->
                    ...
                    <div class="input-group date form_meridian_datetime" data-date="">
                      <input type="text" size="16" class="form-control" value="" name="start_date">
                ...
                <div class="col-md-6"> 
                  <div class="form-group col-md-12">
                    ...
                    <div class="input-group date form_meridian_datetime" data-date="">
                      <input type="text" size="16" class="form-control" value="" name="end_date">
                      <span class="input-group-btn">
                      <button class="btn default date-reset" type="button">
                      <i class="fa fa-times"></i>
                      </button>
                ...
                <div class="col-md-6"> 
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <input type="text" name="unit_value" required="required" class="form-control">
