...
<form action="<?php echo SURL ?>admin/candle-report-test/chart" name="" method="post" >
...
?>
      ...
      <input type="text" name="look_back" id="look_back" class="form-control look_back" value="<?php echo $page_post_data['look_back'];?>" autocomplete="off" />
    </div>
            <!--<div class="form-group col-md-1">
      <label>Hours</label>
      ...
      <!-- <button class="btn btn-danger" name="clear" id="clear">Clear</button>-->
