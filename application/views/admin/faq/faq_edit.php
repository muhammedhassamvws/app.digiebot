   ...
   <div class="widget widget-inverse">
      ...
      <div class="widget-body" style="background: #ccc;">
      	...
      	<div class="form-group">
		    ...
		    <textarea class="form-control" name="faq_question" id="faq_question"><?=$faq['faq_question'];?></textarea>
	  	</div>
	  <div class="form-group">
	    <label for="pwd">Answer:</label>
	    <textarea class="form-control" name="faq_answer" id="faq_answer"><?=$faq['faq_answer'];?></textarea>
	  </div>

    <?php echo $faq['faq_type']; ?>
	  <div class="form-group">
	    <label>Type</label>
	    <select class="form-control" id="faq_type" name="faq_type">
	    	<option <?php echo ($faq['faq_type'] == "Digiebot" ? "selected" : ""); ?>>Digiebot</option>
        <option <?php echo ($faq['faq_type'] == "Balance" ? "selected" : ""); ?>>Balance</option>
	    	<option <?php echo ($faq['faq_type'] == "Trades" ? "selected" : ""); ?>>Trades</option>
	    	<option <?php echo ($faq['faq_type'] == "Rules" ? "selected" : ""); ?>>Rules</option>
	    	<option <?php echo ($faq['faq_type'] == "Triggers" ? "selected" : ""); ?>>Triggers</option>
	    	<option <?php echo ($faq['faq_type'] == "Errors" ? "selected" : ""); ?>>Errors</option>
        <option <?php echo ($faq['faq_type'] == "Others" ? "selected" : ""); ?>>Others</option>
	    </select>
	  </div>
    <input type="hidden" id="hidden-id" name="hidden_id" value="<?php echo $faq['_id'] ?>">
...
<script type="text/javascript">
    ...
    //auto_fill_data();
      ...
      var hidden_id = $('#hidden-id').val();
			...
			$.ajax({
				url: "<?php echo SURL; ?>admin/faq_admin/faq_update_process",
				type: "POST",
...
//  var que = <?=$faq['faq_question'];?>;
//  var answer = <?=$faq['faq_answer'];?>;
//  CKEDITOR.instances.faq_question.setData(que);
//  CKEDITOR.instances.faq_answer.setData(asnwer);
// };
</script>