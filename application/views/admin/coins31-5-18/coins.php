           ...
           <tr class="gradeX">
              ...
              <td class="center">
                <div class="btn-group btn-group-xs ">
                    <a href="<?php echo SURL.'admin/coins/edit-coin/'.$coins_arr[$i]['id'];?>" class="btn btn-inverse"><i class="fa fa-pencil"></i></a>
                    <a href="<?php echo SURL.'admin/coins/delete-coin/'.$coins_arr[$i]['id'];?>" class="btn btn-danger" onclick="return confirm('Are you sure want to delete?')"><i class="fa fa-times"></i></a>
                </div>
               </td>
            </tr>
           <?php }
